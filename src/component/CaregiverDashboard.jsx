  ...
  const elders = [
    {
      ...
      healthPrecautions: "Diabetes, mobility issues",
      tasks: [
        { id: 1, name: "Breakfast", completed: true, time: "8:00 AM" },
        { id: 2, name: "Morning medication", completed: true, time: "8:30 AM" },
        { id: 3, name: "Lunch", completed: false, time: "12:00 PM", overdue: true },
        { id: 4, name: "Afternoon medication", completed: false, time: "1:00 PM" },
        { id: 5, name: "Exercise", completed: false, time: "3:00 PM" },
      ],
    },
    {
      id: 2,
      name: "Robert Wilson",
      age: 82,
      photo: "/elderly-man-contemplative.png",
      currentMood: "neutral",
      lastCheckIn: "Today, 8:15 AM",
      healthPrecautions: "Heart condition, hearing impaired",
      tasks: [
        { id: 1, name: "Breakfast", completed: true, time: "7:30 AM" },
        { id: 2, name: "Morning medication", completed: true, time: "8:00 AM" },
        { id: 3, name: "Physical therapy", completed: false, time: "10:00 AM" },
        { id: 4, name: "Lunch", completed: false, time: "12:30 PM" },
        { id: 5, name: "Afternoon medication", completed: false, time: "1:30 PM" },
      ],
    },
  ]
